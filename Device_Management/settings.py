...
SECRET_KEY = "django-insecure-%0)93g2s&)sku3l3093@!$5f6n@4o-w&i%(&o$-ntxv5%*$=ds"
...
# Additional configuration for Prometheus middleware
PROMETHEUS_MIDDLEWARE = {
    'job_name': 'django-app',  # Specify the job name here
}